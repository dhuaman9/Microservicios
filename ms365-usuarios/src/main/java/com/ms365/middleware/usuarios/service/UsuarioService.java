...
public class UsuarioService {
  ...
  public List<UsuarioDTO> findAll() throws Exception {
	...
	logger.info(" debug usuario service > metodo findAll"); //debug
...
//    Page<UsuarioDomain> pageDomain = this.usuarioRepository.findAll(pageable); //daniel
	  ...
	  logger.info(" debug  > metodo findAll pageable"); //debug
  ...
  public UsuarioDTO findById(Integer id, Map<String, String> headers) throws Exception {
	  logger.info(" debug  > metodo findById  "); //debug
	  logger.info(" debug  > metodo findById , params: id :"+id +"headers: "+headers); //debug
  ...
  public UsuarioDTO findByUserName(String userName) throws Exception {
	  logger.info(" debug  > metodo findByUserName  :" +userName); //debug
    UsuarioDTO dto = null;
